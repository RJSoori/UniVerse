...
import { GpaWidget } from "../gpa-calculator/GpaWidget";
  ...
  useEffect(() => {
    const loadData = () => {
      ...
      const transactions = JSON.parse(
        localStorage.getItem("money-transactions") || "[]",
      );
      const events = JSON.parse(
        localStorage.getItem("schedule-events") || "[]",
      );
      const habits = JSON.parse(localStorage.getItem("habits") || "[]");
      const subjects = JSON.parse(
        localStorage.getItem("university-grades") || "[]",
      );
      ...
      // GPA Calculation from new system
      const gpaSemesters = JSON.parse(
        localStorage.getItem("gpa-semesters") || "[]",
      );
      const gpaSettings = JSON.parse(
        localStorage.getItem("gpa-settings") || "{}",
      );
